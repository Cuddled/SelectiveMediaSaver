...
export function buildSemanticOverrides(value: unknown): Record<string, string> {
	...
	Object.assign(overrides, {
		...
		INTERACTIVE_TEXT_ACTIVE: semanticColor(text, 1),
		INTERACTIVE_TEXT_DEFAULT: semanticColor(text, 0.9),
		INTERACTIVE_TEXT_HOVER: semanticColor(text, 1),
		MOBILE_TEXT_HEADING_PRIMARY: semanticColor(text, 1),
