...
The Revenge Next port is currently `2.4.0-next5`, a beta build for this tested client stack:
...
build/dist/com.cuddled.selectivemediasaver@2.4.0-next5.zip
```
...
`2.4.0-next5` remains on the beta channel. Promote only after testing installation, settings,
